...
class UsersApp_c extends RestController {
    ...
    public function detail_get(){
        $id = $this->get( 'id' );
        $data_users = $this->Api_m->CountPengaduan($id);
	...
	public function pengaduanOk_get(){
        $id = $this->get( 'id' );
        $data_users = $this->Api_m->pengaduanOk($id);
	...
	public function pengaduanNotOk_get(){
        $id = $this->get( 'id' );
        $data_users = $this->Api_m->pengaduanNotOk($id);

        if($data_users){
            $this->response( [
                'countNotOk' =>$data_users,
                'error' => false,
                'message' => "success get Data"
                ],200 );
        }else{
